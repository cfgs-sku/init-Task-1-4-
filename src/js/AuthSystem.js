...
function _checkProjectSelected(){
  setTimeout(function(){
    // 招采主管 / 管理员不需要绑定项目，跳过提示
    var cur = typeof AuthSystem !== 'undefined' ? AuthSystem.current() : null;
    if(cur && (cur.role === 'hmq' || cur.role === 'manager' || cur.role === 'admin')) return;
...
var AuthSystem = (function(){
  ...
  var ROLE_PERMS = {
    ...
    hmq:     { editDB:true,  addSKU:true,  delSKU:true,  viewLog:true,  manageUser:false, submitDemand:true,  approveDemand:true },
